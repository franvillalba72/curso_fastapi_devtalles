...
if TYPE_CHECKING:
    from .author import AuthorORM  # Importación condicional para evitar problemas de importación circular
    from .tag import TagORM  # Importación condicional para evitar problemas de importación circular
